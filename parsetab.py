...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign',u'start3.py',61),
  ('statement -> expression','statement',1,'p_statement_expr',u'start3.py',65),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop',u'start3.py',69),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop',u'start3.py',70),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop',u'start3.py',71),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop',u'start3.py',72),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus',u'start3.py',79),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group',u'start3.py',83),
  ('expression -> NUMBER','expression',1,'p_expression_number',u'start3.py',87),
  ('expression -> NAME','expression',1,'p_expression_name',u'start3.py',91),
]
